...
class Form extends Component {
  ...
  componentWillMount() {
    axios.get('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/languages')
    .then((response) => {
    ...
    axios.get('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/countries').then((response) => {
