...
class ContactList extends Component {
  ...
  getContacts() {
    axios.get('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/users?user=' + this.props.session.id).then((response) => {
  ...
  createRequest(user, event) {
    axios.post('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/contacts', {
  ...
  acceptRequest(contact, event) {
    axios.patch('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/contacts/' + contact.id, {
      status: 'accepted',
    }).then((response) => {
  ...
  declineRequest(contact, event) {
    axios.delete('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/contacts/' + contact.id).then((response) => {
  ...
  updateSearch(event) {
    ...
    if (query === '') {
      ...
      axios.get('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/search?user=' + this.props.session.id + '&query=' + query).then((response) => {
        const contacts = response.data;
        this.setState({
          contacts: contacts,
        })
