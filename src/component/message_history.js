...
class MessageHistory extends Component {
  ...
  getMessages() {
    ...
    axios.get('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/messages?from=' + this.props.session.id + '&to=' + this.props.contact.user.id).then((response) => {
  ...
  sendMessage(event) {
    ...
    if (event.target.message.value !== '') {
      axios.post('http://example-env.mpmpcu8qtu.us-west-2.elasticbeanstalk.com/messages', {
